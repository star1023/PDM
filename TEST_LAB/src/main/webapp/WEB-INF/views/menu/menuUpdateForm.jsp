...
var selectedArr = new Array();
	...
	function fn_updateTmp(){
		if( !chkNull($("#title").val()) ) {
			...
			formData.append("newItemTypeCodeArr", newItemTypeCodeArr);	
...
<div class="wrap_in" id="fixNextTag">
	...
	<section class="type01">
		<h2 style="position:relative">
			<span class="title_s">Menu Update Doc</span><span class="title">메뉴개발완료보고서</span>
					...
					<table id="matTable" class="tbl05">
						...
						<c:forEach items="${menuMaterialData}" var="menuMaterialData" varStatus="status">
							...
							<tr id="newMatRow_${status.count}" class="temp_color">
								<td>
									<input type="checkbox" id="newMat_${status.count}"><label for="newMat_${status.count}"><span></span></label>
			...
			<div class="main_tbl">
				...
				<div class="btn_box_con4">
					...
					<button class="btn_admin_navi">임시저장</button>
					 -->
					<c:if test="${menuData.data.STATUS == 'TMP' }">
