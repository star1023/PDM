...
<div class="wrap_in" id="fixNextTag">
	<span class="path">
		계정 리스트&nbsp;&nbsp;<img src="/resources/images/icon_path.png" style="vertical-align:middle"/>&nbsp;&nbsp;
	...
	<!-- 상세 페이지  start-->
		<h2 style="position:relative">
			<span class="title_s">user account</span>
			<span class="title">계정 리스트</span>
...
<%--					<h5 class="bullet-tit">계정 리스트</h5>--%>
					...
					<div id="userList" style="width: 100%" >
						<bdo Debug=""
							 Layout_Url="/AdminReport/userListLayout?gridId=userList"
