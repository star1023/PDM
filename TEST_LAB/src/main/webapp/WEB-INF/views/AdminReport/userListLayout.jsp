...
<%--
  Class Name : userListLayout.jsp
  Description : 계정 리스트
  Modification Information
 
       수정일    	     수정자                   수정내용
   -------    --------    ---------------------------
   2023.01.09  최광해	              최초 생성
...
<Grid>
<%--	<Cfg	id="${gridId}"--%>
<%--			AcceptEnters   = "1" Calculated = "1"  CalculateSelected = "1"      DateStrings = "2" Deleting  = "0" ShowDeleted="1"--%>
...
<%--			SelectingCells = "1" SortIcons  = "0"  Style             = "Standard" SuppressCfg = "1"--%>
...
<%--	<Cfg Paging="2" PageLength="12" PageMin="1" MaxPages="10" />--%>
	...
	<Cols>
		...
		<C Name="DEPTCODENAME" 	Type="Text" RelWidth="100" CanEdit="0" Visible="1" Align="center" CanExport="1" />
		<C Name="TEAMCODENAME" 	Type="Text" RelWidth="100" CanEdit="0" Visible="1" Align="center" CanExport="1" />
		<C Name="USERGRADENAME" Type="Text" RelWidth="100" CanEdit="0" Visible="1" Align="center" CanExport="1" />
		<C Name="REGDATE" 		Type="Date" RelWidth="100" CanEdit="0" Visible="1" Align="center" CanExport="1" Format="yyyy-MM-dd" />
		<C Name="ISDELETE" 		Type="Text" RelWidth="100" CanEdit="0" Visible="1" Align="center" CanExport="1" />
		<C Name="ISLOCK" 		Type="Text" RelWidth="100" CanEdit="0" Visible="1" Align="center" CanExport="1" />
