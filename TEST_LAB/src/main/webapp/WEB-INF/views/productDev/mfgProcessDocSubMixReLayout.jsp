...
<%--
  Class Name : mfgProcessDocSubMixReLayout.jsp
  Description : 접포용 제조공정서 배합비, 내용물
  Modification Information
 
    수정일    	수정자                 수정내용
   -------    --------    ---------------------------
   2023.11.06  정민균	              최초 생성(원본mfgProcessDocSubMixLayout)
...
<%--		<Filter	id="Filter"	CanFocus="1" />--%>
	...
	<Cols>	
		<C Name="ITEMCODE"			Type="Text" RelWidth="100" CanEdit="${edit}" Visible="1" Align="left" CanExport="1" />
		<C Name="ITEMNAME"			Type="Text" RelWidth="100" CanEdit="${edit}" Visible="1" Align="left" CanExport="1" />	
		<C Name="WEIGHT" 			Type="Float" RelWidth="100" CanEdit="${edit}" Visible="1" Align="left" CanExport="1" Format="###0.00"/>
		<C Name="INGRADIENT" 		Type="Text" RelWidth="100" CanEdit="${edit}" Visible="1" Align="left" CanExport="1" />
	</Cols>

	<Foot>
		<I Calculated = "1" type = "Float" Spanned = "1" Align = "left" CanExport = "0" Format = "###0.00"
		   ITEMCODE = "합계" ITEMCODEColor = "#37aad9" ITEMCODEClass = "gridStatus5" ITEMCODESpan = "2" ITEMCODEAlign = "center"
		   ITEMCODECanEdit="0" ITEMNAMECanEdit="0"  INGRADIENTCanEdit="0"
		   WEIGHTFormula='sum()'
	...
	<Solid>
		<%--
		<I  id="PAGER"	Cells="NAV,LIST,ONE,GROUP"	Space="0"
