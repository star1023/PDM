		...
		<tr>
			...
			<th colspan="2" style="text-align: right">
				...
				<span style="font-size: 9px">
					<input class="designInput" type="text" name="nutritionLabel.weightText" placeholder="(00g 0개)" style="padding: 2px; width: 65px; font-size: 11px">
				</span>
			</th>
		</tr>
		<tr>
			<th colspan="2" style="text-align: right">
				<span style="font-size: 9px">
					<input class="designInput" type="text" name="nutritionLabel.kcalText" placeholder="1개(00g)당" style="padding: 2px; width: 40%;">
					<input class="designInput" type="text" name="nutritionLabel.kcal" value="000" style="padding: 2px; width: 30px;">kcal
				</span>
			</th>
		</tr>
	</thead>
