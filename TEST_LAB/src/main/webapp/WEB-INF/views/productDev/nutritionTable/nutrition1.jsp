...
<table class="nutrientTable">
	...
	<thead>
		...
		<tr>
			<th colspan="2" style="text-align: right">
				<span style="font-size: 9px"><input class="designInput" type="text" name="nutritionLabel.kcal" value="000" style="padding: 2px; width: 30px;" number>kcal</span>
			</th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td colspan="2">총 내용량당</td>
