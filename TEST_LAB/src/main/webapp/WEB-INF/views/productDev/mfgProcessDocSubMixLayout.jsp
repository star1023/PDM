...
<%--
  Class Name : mfgProcessDocSubMixLayout.jsp
  Description : 접속이력
  Modification Information
 
    수정일    	수정자                 수정내용
   -------    --------    ---------------------------
   2023.02.27  최광해	              최초 생성
...
<%--		<Filter	id="Filter"	CanFocus="1" />--%>
	...
	<Cols>
		...
		<C Name="BOMAMOUT" 		Type="Float" RelWidth="100" CanEdit="${edit}" Visible="1" Align="left" CanExport="1" Format="###0.00"/>
		<C Name="MANUCOMPANY"	Type="Text" RelWidth="100" CanEdit="${edit}" Visible="1" Align="left" CanExport="1" />
	...
	<Foot>
		<I Calculated = "1" type = "Float" Spanned = "1" Align = "left" CanExport = "0" Format = "###0.00"
		   ITEMNAME = "합계" ITEMNAMEColor = "#37aad9" ITEMNAMEClass = "gridStatus5" ITEMNAMESpan = "1" ITEMNAMEAlign = "center"
		   ITEMNAMECanEdit="0" MANUCOMPANYCanEdit="0" INGRADIENTCanEdit="0"
		   BOMAMOUTFormula='sum()'
