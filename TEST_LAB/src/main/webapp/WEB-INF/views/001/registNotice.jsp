		...
		$('#noticeRegistForm').ajaxForm({
            ...
            success: function(response,result){
            	if(result == 'success'){
                	//성공후 서버에서 받은 데이터 처리
                	alert("공지사항 작성 하였습니다.");
                	location.href="/adminNotice/noticeList?&pageNo="+'${pageNo}'+"&keyword="+encodeURI(encodeURIComponent('${paramVO.keyword}'))+'&searchName='+encodeURI(encodeURIComponent('${paramVO.searchName}'))+'&startDate='+'${paramVO.startDate}'+"&endDate="+'${paramVO.endDate}';
            	} else {
...
<%--  <form id="noticeRegistForm" name="noticeRegistForm" method="post" enctype="multipart/form-data" action="/adminNotice/noticeRegistAction">
		<span class="path">
