...
<form name="contentsForm" id="contentsForm" method="post" enctype="multipart/form-data" action = "/QnaNotice/QnaModifyNoticeAjax">
<%--  <input type="hidden" id="nNo"name="nNo" value="${data1.nNo }">
	...
	<section class="type01">
		...
		<div class="group01" >
			...
			<div class="main_tbl">
				<ul class="notice_view">
					<li>
						...
						<ul class="view_list_file" id="filelist">
							<c:forEach items="${QnafileNames}" var="item" varStatus="status">
								<li>
			...
			<input type="hidden" id="nNo" name="nNo" value="${data1.nNo }">
			<input type="hidden" id="regUserId" name="regUserId" value="${data1.regUserId}">
...
<dd><!-- 첨부파일이 하나도 없을때는 add_file2 / 하나라도 생성되면 add_file 로 클래스명 교체해주세요-->
			...
			<c:if test="${fn:length(QnafileNames) > 0 }">
				<div class="add_file" id="add_file2" style="width:97.5%">
			</c:if>
			<c:if test="${fn:length(QnafileNames) eq 0 }">
