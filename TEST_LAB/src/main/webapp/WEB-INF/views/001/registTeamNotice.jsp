...
/* 		$("#fileSpan"+fileIdx).hide();
	...
	<form id="noticeRegistForm" name="noticeRegistForm" method="post" enctype="multipart/form-data" action="/teamNotice/noticeRegistAction">
		<!-- <span class="path">
	...
	<span class="title">${deptName}팀 게시글 작성</span>
	<div  class="top_btn_box">
			<ul>
