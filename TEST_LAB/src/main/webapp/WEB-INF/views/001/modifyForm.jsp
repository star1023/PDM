...
<form name="contentsForm" id="contentsForm" method="post" enctype="multipart/form-data" action = "/adminNotice/modifyNoticeAjax">
...
<%-- 			<div id="hidden" style="display:none"><input type="hidden" name="fileDelete"></div>
			<li class=" mb5">
			<dt >파일리스트 </dt><dd>
...
<dd><!-- 첨부파일이 하나도 없을때는 add_file2 / 하나라도 생성되면 add_file 로 클래스명 교체해주세요-->
			...
			<c:if test="${fn:length(fileNames) eq 0 }">
