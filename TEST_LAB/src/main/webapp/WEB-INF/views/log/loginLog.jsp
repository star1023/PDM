	...
	function loadList(pageNo){
		...
		$.ajax({
			...
			success:function(data) {
				var html = "";
				if(data.loginLogList.length <= 0){
					html = "<tr><td align='center' colspan='6'>등록된 내용이 없습니다.</td></tr>"
				} else {
					for (var i = 0; i < data.loginLogList.length; i++) {
						var row = data.loginLogList[i];
		...
		<div class="group01">
			...
			<div class="tab02">
				<ul>
					...
					<a href="/log/loginLog"><li class="select">로그인</li></a>
			...
			<div class="main_tbl">
				<table class="tbl01">
					...
					<tbody id="list">
						<tr><td align='center' colspan='6'>조회중입니다.</td></tr>
					</tbody>
				</table>
