...
function fn_loadList(pageNo) {
	var URL = "../report2/selectNewProductResultListAjax";
...
function fn_insertForm() {
	window.location.href = "../report2/newProductResultInsert";
}

function fn_view(idx) {
	window.location.href = "../report2/newProductResultView?idx="+idx;
}

function fn_update(idx) {
	location.href = '/report2/newProductResultForm?idx='+idx;
}
