						...
						<tr>
							...
							<td colspan="3">
								<table width="100%">
									...
									<tr>
										<td>
											<input type="text" name="a" id="a" style="width: 100%;" class="req" />
										</td>
										<td>
											<input type="text" name="b" id="b" style="width: 100%;" class="req" />
										</td>
										<td>
											<input type="text" name="c" id="c" style="width: 100%;" class="req" />
										</td>
									</tr>
									<tr>
										<td>
						...
						<tr>
							...
							<td colspan="3">
								<table width="100%" border="0">
									<tr>
										<td>
											<input type="text" name="d" id="d" style="width: 100%;" class="req" />
										</td>
									</tr>
									<tr>
										<td>
