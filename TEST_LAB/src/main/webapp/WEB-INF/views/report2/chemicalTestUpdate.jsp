...
/*			
			...
			*/
			...
			var URL = "../report2/updateChemicalTestAjax";
			$.ajax({
				type:"POST",
				url:URL,
				data: formData,
	...
	function fn_goList() {
		location.href = '/report2/chemicalTestList';
	}
	...
	function fn_search() {
		var URL = "../report2/searchChemicalTestAjax";
		$.ajax({
			type:"POST",
			url:URL,
			data:{
	...
	function fn_copy(idx) {
		var URL = "../report2/selectChemicalTestDataAjax";
		$.ajax({
			type:"POST",
			url:URL,
			data:{
