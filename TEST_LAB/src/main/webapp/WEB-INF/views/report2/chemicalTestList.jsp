...
function fn_loadList(pageNo) {
    var URL = "../report2/selectChemicalTestListAjax";
...
function fn_insertForm() {
	window.location.href = "../report2/chemicalTestInsert";
}

function fn_view(idx) {
	window.location.href = "../report2/chemicalTestView?idx="+idx;
}

function fn_update(idx) {
	location.href = '/report2/chemicalTestForm?idx='+idx;
}
