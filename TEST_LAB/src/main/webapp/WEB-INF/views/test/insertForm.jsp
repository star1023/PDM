			...
			<div class="list_detail">
				<ul style="border-top:none;">
					...
					<li>
						<dt>보관기준</dt>
						<dd>
							<input type="text" class="req" style="width:149px;" name="keepCondition" id="keepCondition">
						</dd>
					</li>
					<li>
						<dt>사이즈</dt>
						<dd>
							<input type="text" class="req" style="width:49px;" name="width" id="width" onkeyup="checkDecNum(this)"> /
							<input type="text" class="req" style="width:49px;" name="length" id="length" onkeyup="checkDecNum(this)"> /
							<input type="text" class="req" style="width:49px;" name="height" id="height" onkeyup="checkDecNum(this)">
						</dd>
					</li>
					<li>
						<dt>중량</dt>
						<dd>
							<input type="text" class="req" style="width:149px;" name="weight" id="weight" placeholder="숫자만 입력하세요." onkeyup="checkDecNum(this)">
						</dd>
					</li>
					<li>
						<dt>규격</dt>
						<dd>
							<input type="text" class="req" style="width:302px;" name="standard" id="standard">
						</dd>
					</li>
					<li>
						<dt>원산지</dt>
						<dd>
							<input type="text" class="req" style="width:302px;" name="origin" id="origin">
						</dd>
					</li>
					<li>
						<dt>유통기한</dt>
