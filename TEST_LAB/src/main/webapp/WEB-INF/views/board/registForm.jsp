...
<form id="reigstPostForm" name="noticeRegistForm" method="post" enctype="multipart/form-data" action="/board/registPost">
	<input type="hidden" name="type" value="${type}">
	<input type="hidden" name="typeText" value="${typeText}">

	<div class="wrap_in" id="fixNextTag">
		<span class="path">게시글 작성&nbsp;&nbsp;<img src="../resources/images/icon_path.png" style="vertical-align: middle" />&nbsp;&nbsp;${typeText} 게시판&nbsp;&nbsp;<img src="../resources/images/icon_path.png" style="vertical-align: middle" />&nbsp;&nbsp;게시판&nbsp;&nbsp;<img src="../resources/images/icon_path.png" style="vertical-align: middle" />&nbsp;&nbsp;<a href="#">${strUtil:getSystemName()}</a></span>
		<section class="type01">
			<h2 style="position: relative">
				<span class="title_s">Regist Post</span> <span class="title">게시글 작성</span>
