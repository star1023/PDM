...
<script type="text/javascript">
	...
	function goList() {
		window.location.href="../manufacturingNo/statusList";
	}
	...
	function changeVersion(versionNo, seq){
		...
		/* window.location.href="/manufacturingNo/statusView?licensingNo="+licensingNo+"&manufacturingNo="+manufacturingNo+"&seq="+seq+"&versionNo="+versionNo+"&docNo="+docNo;	
		 */
		var form = document.createElement("form"); // 폼객체 생성
		$('body').append(form);
		form.action = "/manufacturingNo/statusView";
			...
			if(confirm("변경요청 내용은 수정할 수 없습니다. \n변경요청하시겠습니까?")){
				...
				$.ajax({
					...
					success		: function(result){
						...
						hrefText = "/manufacturingNo/statusView?licensingNo="+licensingNo+"&manufacturingNo="+manufacturingNo+"&versionNo="+versionNo+"&seq="+seq+"&docNo="+docNo;
